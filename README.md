...
<p align="center">
  <a href="https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.15-beta/GestureClip-v0.6.15-beta-win-x64.zip"><strong>⬇ 下载 v0.6.15 Beta</strong></a>
  ·
  <a href="https://github.com/hhuhuwang-gif/GestureClip.App/releases/tag/v0.6.15-beta">Release 说明</a>
  ·
...
| 资源 | 链接 |
| --- | --- |
| 安装包 | [GestureClip-v0.6.15-beta-win-x64.zip](https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.15-beta/GestureClip-v0.6.15-beta-win-x64.zip) |
| 校验文件 | [SHA256SUMS.txt](https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.15-beta/SHA256SUMS.txt) |
| 全部版本 | [Releases](https://github.com/hhuhuwang-gif/GestureClip.App/releases) |

### 本版亮点

- **剪贴板一键回顶** / `Home`·`End`；打开后选中最新；「重置」清搜索并回全部
- **`Ctrl+Enter` 粘贴不关窗**；删除后选下一条；**`Ctrl+Z` 撤销删除**
- **`Ctrl+Shift+C` 纯文本复制**；`?` / `F1` 快捷键速查
- 延续 0.6.14：快捷动作面板、左键增强、工位小熊 Hub、Apple 风 UI

完整说明见 [CHANGELOG.md](CHANGELOG.md) 与 [Release Notes](https://github.com/hhuhuwang-gif/GestureClip.App/releases/tag/v0.6.15-beta)。
...
目前 v0.6.15 Beta，Windows x64，解压双击 GestureClip.exe 就能跑。
