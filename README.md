...
<p align="center">
  <a href="https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.20-beta/GestureClip-v0.6.20-beta-win-x64.zip"><strong>⬇ 下载 v0.6.20 Beta</strong></a>
  ·
  <a href="https://github.com/hhuhuwang-gif/GestureClip.App/releases/tag/v0.6.20-beta">Release 说明</a>
  ·
...
| 资源 | 链接 |
| --- | --- |
| 安装包 | [GestureClip-v0.6.20-beta-win-x64.zip](https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.20-beta/GestureClip-v0.6.20-beta-win-x64.zip) |
| 校验文件 | [SHA256SUMS.txt](https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.20-beta/SHA256SUMS.txt) |
| 全部版本 | [Releases](https://github.com/hhuhuwang-gif/GestureClip.App/releases) |

### 本版亮点

- **多选进度**：已复制项左侧色条变绿 + 底栏「已选 / 已复制」计数
- **智能粘贴修复**：只净化剪贴板，统一可靠 `Ctrl+V`
- **下滑粘贴**：跨机加固、不误弹右键菜单
- **全局 `Ctrl+Shift+V` 纯文本粘贴**；链接净化 / 快捷动作
- **更新**：多路径下载便携 zip 覆盖（数据在 `%LOCALAPPDATA%\GestureClip`）

完整说明见 [CHANGELOG.md](CHANGELOG.md) 与 [Release Notes](https://github.com/hhuhuwang-gif/GestureClip.App/releases/tag/v0.6.20-beta)。
...
目前 v0.6.20 Beta，Windows x64，解压双击 GestureClip.exe 就能跑。
