...
<p align="center">
  <a href="https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.19-beta/GestureClip-v0.6.19-beta-win-x64.zip"><strong>⬇ 下载 v0.6.19 Beta</strong></a>
  ·
  <a href="https://github.com/hhuhuwang-gif/GestureClip.App/releases/tag/v0.6.19-beta">Release 说明</a>
  ·
...
| 资源 | 链接 |
| --- | --- |
| 安装包 | [GestureClip-v0.6.19-beta-win-x64.zip](https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.19-beta/GestureClip-v0.6.19-beta-win-x64.zip) |
| 校验文件 | [SHA256SUMS.txt](https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.19-beta/SHA256SUMS.txt) |
| 全部版本 | [Releases](https://github.com/hhuhuwang-gif/GestureClip.App/releases) |

### 本版亮点

- **智能粘贴修复**：改写剪贴板后统一走可靠 `Ctrl+V`（开启智能粘贴也可正常粘贴）
- **下滑手势粘贴跨机加固**：焦点恢复 + 多层注入（SendInput / keybd_event / WM_PASTE）
- **全局 `Ctrl+Shift+V` 纯文本粘贴**；链接净化 / HTML→文本 / Markdown
- **UI**：剪贴板分段筛选、深色模式、快捷动作 Spotlight、手势轨迹、小熊 Emoji
- **更新**：多路径下载 GitHub 便携包后覆盖程序目录（数据不丢）

完整说明见 [CHANGELOG.md](CHANGELOG.md) 与 [Release Notes](https://github.com/hhuhuwang-gif/GestureClip.App/releases/tag/v0.6.19-beta)。
...
目前 v0.6.19 Beta，Windows x64，解压双击 GestureClip.exe 就能跑。
