...
<p align="center">
  ...
  ·
  <a href="https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.33-beta/GestureClip-v0.6.33-beta-win-x64.zip"><strong>v0.6.33 Beta zip</strong></a>
  ·
  <a href="https://github.com/hhuhuwang-gif/GestureClip.App/releases/tag/v0.6.33-beta">Release 说明</a>
  ·
...
| 安装包 | [GestureClip-v0.6.33-beta-win-x64.zip](https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.33-beta/GestureClip-v0.6.33-beta-win-x64.zip) |
| 校验文件 | [SHA256SUMS.txt](https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.33-beta/SHA256SUMS.txt) |
| 历史版本 | 旧版在 Releases 里标记为 **Pre-release**，默认请用 Latest |

### 本版亮点（v0.6.33）

- **手势 HUD 统计行可读**：`手势 · 复制 · 粘贴 · 少点` 高对比白字 + 底衬，不再发灰看不清
- **工位小熊 Hub 质感**（0.6.32）：阶段色、进度条、空状态引导、重置确认、Esc
...
v0.6.33 起历史再复制会统一写成纯文本；也可用「复制为纯文本」或 `Ctrl+Shift+C`。
...
**为什么 GitHub 上还有很多旧版本？**  
历史包仍保留下载；已标为 Pre-release。日常请只用 **Latest = v0.6.33 Beta**。
...
v0.6.33 Beta，解压双击 GestureClip.exe。
