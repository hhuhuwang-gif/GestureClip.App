...
<p align="center">
  <a href="https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.14-beta/GestureClip-v0.6.14-beta-win-x64.zip"><strong>⬇ 下载 v0.6.14 Beta</strong></a>
  ·
  <a href="https://github.com/hhuhuwang-gif/GestureClip.App/releases/tag/v0.6.14-beta">Release 说明</a>
  ·
...
| 资源 | 链接 |
| --- | --- |
| 安装包 | [GestureClip-v0.6.14-beta-win-x64.zip](https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.14-beta/GestureClip-v0.6.14-beta-win-x64.zip) |
| 校验文件 | [SHA256SUMS.txt](https://github.com/hhuhuwang-gif/GestureClip.App/releases/download/v0.6.14-beta/SHA256SUMS.txt) |
| 全部版本 | [Releases](https://github.com/hhuhuwang-gif/GestureClip.App/releases) |

### 本版亮点

- **快捷动作面板**：本地去空格 / 大小写 / JSON / URL 等，可预览、复制、粘贴
- **手势绑定助手动作**；设置页可改快捷动作热键
- **左键增强动作**可在「动作绑定」页配置（右键画手势时再点左键）
- **工位小熊**：Hub 分区折叠、30 秒开工引导、休息日/周上限、托盘摘要与分享卡片
- **UI**：Apple 风格侧栏与交通灯（红关 / 黄放大 / 绿缩小）；主按钮对比度修复
- **更新**：检查更新展示 Release 说明；关于页内置 CHANGELOG

完整说明见 [CHANGELOG.md](CHANGELOG.md) 与 [Release Notes](https://github.com/hhuhuwang-gif/GestureClip.App/releases/tag/v0.6.14-beta)。
...
目前 v0.6.14 Beta，Windows x64，解压双击 GestureClip.exe 就能跑。
