...
public sealed class GitHubReleaseUpdateInstallerService : IUpdateInstallerService
{
    ...
    private Task LaunchSetupExeAsync(string setupExePath, CancellationToken cancellationToken)
    {
    ...
    private Task LaunchSetupZipAsync(string zipPath, string updateRoot, CancellationToken cancellationToken)
    {
