...
public static class AppServiceCollectionExtensions
{
    public static IServiceCollection AddGestureClipApp(this IServiceCollection services, AppPathProvider paths)
    {
        ...
        services.AddSingleton<QuickActionCenterService>();
        services.AddSingleton<IQuickActionCenterService>(provider => provider.GetRequiredService<QuickActionCenterService>());
        ...
        services.AddTransient<QuickActionCenterViewModel>();
