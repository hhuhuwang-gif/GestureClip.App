...
public sealed partial class SettingsViewModel
{
    ...
    private static string ShortcutText(BuiltInGestureAction action) => action switch
    {
        ...
        BuiltInGestureAction.InsertDate => "Date",
        BuiltInGestureAction.InsertTime => "Time",
        BuiltInGestureAction.InsertDateTime => "DateTime",
        BuiltInGestureAction.InsertSnippet1 => "Snippet1",
        BuiltInGestureAction.InsertSnippet2 => "Snippet2",
        BuiltInGestureAction.InsertSnippet3 => "Snippet3",
