...
public static class GestureActionText
{
    public static string Name(BuiltInGestureAction action) => action switch
    {
        ...
        BuiltInGestureAction.InsertDate => "插入今天日期",
        BuiltInGestureAction.InsertTime => "插入当前时间",
        BuiltInGestureAction.InsertDateTime => "插入日期时间",
        BuiltInGestureAction.InsertSnippet1 => "插入话术 1",
        BuiltInGestureAction.InsertSnippet2 => "插入话术 2",
        BuiltInGestureAction.InsertSnippet3 => "插入话术 3",
