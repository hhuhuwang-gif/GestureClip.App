...
public sealed class ReleasePackageSelectorTests
{
    ...
    public void Select_prefers_setup_exe_over_setup_zip_and_portable()
    {
        var assets = new[]
        {
            Asset("GestureClip-v0.6.25-beta-win-x64.zip", "https://example/portable.zip"),
            Asset("GestureClip-Setup-v0.6.25-beta-win-x64.zip", "https://example/setup.zip"),
            Asset("GestureClip-Setup-v0.6.25-beta-win-x64.exe", "https://example/setup.exe"),
        };
